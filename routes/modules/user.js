...
router.put('/:id', authenticatedCurrentUser, putUserProfileValidator, upload.fields([{ name: 'avatar', maxCount: 1 }, { name: 'cover', maxCount: 1 }]), userController.putUserProfile)
