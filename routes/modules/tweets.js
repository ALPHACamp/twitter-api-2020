...
router.route('/:tweet_id/like').post(authenticatedUser, tweetController.likeTweet)
router.route('/:tweet_id/unlike').post(authenticatedUser, tweetController.unlikeTweet)
