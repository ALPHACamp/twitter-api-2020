...
router.post('/followships', authenticated, authenticateUser, followController.addFollow)
router.delete('/followships/:followingId', authenticated, authenticateUser, followController.removeFollow)
