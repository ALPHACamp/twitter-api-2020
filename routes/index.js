...
router.post('/api/tweets/:tweet_id/replies', authenticated, authenticatedUser, tweetController.createReply)
router.get('/api/tweets/:tweet_id/likes', authenticated, authenticatedUser, tweetController.getLikes)
router.post('/api/tweets/:tweet_id/like', authenticated, authenticatedUser, tweetController.likeTweet)
router.post('/api/tweets/:tweet_id/unlike', authenticated, authenticatedUser, tweetController.unlikeTweet)
...
// api/followship
router.delete('/api/followships/:following_id', authenticated, authenticatedUser, followshipController.unfollowUser)
router.get('/api/followships/top10', authenticated, authenticatedUser, followshipController.getTop10)
router.post('/api/followships', authenticated, authenticatedUser, followshipController.followUser)
