  ...
  up: async (queryInterface, Sequelize) => {
    ...
    users.forEach(user => {
      const seed = Array.from({ length: DEFAULT_TWEETS_PER_PERSON }, (_, i) => ({
        ...
        User_id: user.id,
        created_at: faker.date.between('2020-01-01T00:00:00.000Z', '2023-02-01T00:00:00.000Z'),
        updated_at: faker.date.between('2023-02-01T00:00:00.000Z', '2023-02-20T00:00:00.000Z')
      }))
